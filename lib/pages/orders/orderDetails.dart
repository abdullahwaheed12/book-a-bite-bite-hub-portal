import 'package:bite_hub/pages/customers/widgets/customerDetails.dart';
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "\$${widget.documentSnapshot!.get('net_price') - int.parse(widget.documentSnapshot!.get('coupon_discount').toString())}",
                                          style: TextStyle(
                                              fontFamily: "Nunito",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
