...
import 'package:bite_hub/pages/overview/overview.dart';
                      ...
                      Row(
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                loader ? '...' : '\$'+double.parse(totalEarning.toString()).toPrecision(2).toString(),
                                style: const TextStyle(
                                    fontFamily: "Nunito",
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                      ...
                      Row(
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                loaderForProfit ? '...' : '\$'+double.parse(totalProfit.toString()).toPrecision(2).toString(),
                                style: const TextStyle(
                                    fontFamily: "Nunito",
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
